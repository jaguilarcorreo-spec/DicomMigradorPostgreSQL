...
namespace DicomMigrator.Infrastructure.Migrations
{
    ...
    [Migration("20260802185248_DescubrimientoPorJob")]
    partial class DescubrimientoPorJob
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DicomMigrator.Core.Models.DiscoveredStudy", b =>
                {
                    ...
                    b.HasIndex("DiscoveryJobId", "StudyInstanceUid")
                        .IsUnique();
            ...
            modelBuilder.Entity("DicomMigrator.Core.Models.Migration", b =>
                {
                    ...
                    b.Property<int>("PopulateDone")
                        .HasColumnType("integer");

                    b.Property<string>("PopulateError")
                        .HasColumnType("text");

                    b.Property<int?>("PopulateSourceJobId")
                        .HasColumnType("integer");

                    b.Property<string>("PopulateStatus")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<int>("PopulateTotal")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DicomMigrator.Core.Models.MigrationInstance", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("MigrationStudyId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("MigrationStudyId", "SopInstanceUid")
                        .IsUnique()
                        .HasDatabaseName("IX_MigInstances_Study_Sop");

                    b.ToTable("MigrationInstances");
                });
            ...
            modelBuilder.Entity("DicomMigrator.Core.Models.MigrationStudy", b =>
                {
                    ...
                    b.Property<int>("VerifyExtraCount")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("VerifyMissingCount")
                        .HasColumnType("integer");

                    b.Property<string>("VerifyMissingUids")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("DicomMigrator.Core.Models.NotificationOutbox", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DicomMigrator.Core.Models.NotificationSettings", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("NotifyAutoPaused")
                        .HasColumnType("boolean");

                    b.Property<bool>("NotifyCaptureFinished")
                        .HasColumnType("boolean");

                    b.Property<bool>("NotifyDiscoveryCompleted")
                        .HasColumnType("boolean");

                    b.Property<bool>("NotifyDiscoveryFailed")
                        .HasColumnType("boolean");

                    b.Property<bool>("NotifyMigrationCompleted")
                        .HasColumnType("boolean");

                    b.Property<bool>("NotifyMigrationFailed")
                        .HasColumnType("boolean");

                    b.Property<bool>("NotifyPopulateFinished")
                        .HasColumnType("boolean");

                    b.Property<bool>("NotifyVerificationCompleted")
                        .HasColumnType("boolean");

                    b.Property<bool>("NotifyVerificationFailed")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("DicomMigrator.Core.Models.MigrationInstance", b =>
                {
                    b.HasOne("DicomMigrator.Core.Models.MigrationStudy", "Study")
                        .WithMany("Instances")
                        .HasForeignKey("MigrationStudyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
